...
| `book/` | 出版为 Amazon Kindle 电子书：`python3 book/build_book.py` 把全部自撰影评编成《光照在黑暗里：二十一部电影里的救赎》，产出 KDP 上传用的繁体 DOCX、简繁 EPUB、电子书封面与上架文案；`book/build_print.py` 产出 Lulu / IngramSpark 按需印刷用的内文与全包封面 PDF（中文规则、上架与印刷步骤见 `book/README.md`） |
