...
EXISTING_FILMS = [
    "辛德勒的名单",
    "海上钢琴师", "密阳", "盗梦空间", "黑客帝国", "一代宗师",
    "悲惨世界", "唐山大地震", "窃听风暴", "奇异恩典", "赵氏孤儿",
    "深河", "300", "血色将至", "天狗", "Hello！树先生",
    "疯狂的石头", "致我们终将逝去的青春", "车票", "千里走单骑",
    "搜索", "云图", "阿米什的恩典", "母亲",
    "血战钢锯岭", "火星救援", "魔鬼代言人", "小萝莉的猴神大叔",
    "哪吒2", "默杀", "第二十条",
    "黑暗骑士", "超级礼物", "非诚勿扰", "追风筝的人",
    "无间道", "贫民窟的百万富翁", "芳香之旅", "面纱", "12怒汉",
    "V字仇杀队", "赎罪", "赤壁", "一九四二", "让子弹飞",
    "金陵十三钗", "阿凡达", "入殓师", "山楂树之恋", "少年派的奇幻漂流",
    "画皮", "白鹿原", "饮食男女", "2012", "立春",
    "西伯利亚理发师", "剑雨", "生死朗读", "独立时代", "最后一站",
    "二次曝光", "失恋33天", "画皮2", "图雅的婚事", "蓝色 / 红色",
    "功夫熊猫", "功夫熊猫2", "非诚勿扰2", "北京遇上西雅图",
    "那些年，我们一起追的女孩", "天下无贼",
    "一个人的朝圣", "戏台", "好东西", "千与千寻", "书店", "长安的荔枝", "头文字D", "向阳·花", "缝补灵魂的天使", "谁偷了垃圾桶？", "教宗的承继", "漫长的告别", "一点小信仰", "本能反应", "猫猫的奇幻漂流", "大佛普拉斯", "小小的我", "童心列车", "出走的决心", "沉默", "角斗士2", "小丑", "哆啦A梦：伴我同行", "老狐狸", "肖申克的救赎", "假如，我是这世上最爱你的人", "地久天长", "头脑特工队2", "甘古拜·卡蒂娅瓦迪", "周处除三害", "饥饿站台2", "里斯本丸沉没", "逆行人生", "埃及王子", "扫黑·决不放弃", "朝云暮雨", "海蒂与爷爷", "狮子王", "莫娣", "特权乐园", "你想活出怎样的人生", "复活", "热辣滚烫", "困在时间里的父亲", "鹦鹉杀", "思悼", "追梦赤子心", "宾虚", "金币灰黄", "耶稣革命", "孤注一掷",
    "保你平安", "消失的她", "误杀", "绿皮书", "阿甘正传", "白日焰火", "我爱你", "教会", "向阳的日子", "白日梦想家", "妈妈！", "隐入尘烟", "终极胜利", "人生大事", "别告诉她", "陋室", "遗愿清单", "汽车维修站", "勇气警察", "为奴十二年", "盲山", "少年斯派维的奇异旅行", "在我消失前", "战争房间", "寻龙传说", "大内密探零零发", "意外制造公司", "送你一朵小红花", "我的姐姐", "熔炉", "临终千言", "你好，李焕英", "温暖的抱抱", "人生遥控器", "妙手情真", "疯狂原始人2", "一秒钟", "神奇女侠1984", "心灵奇旅", "夺冠", "猩球崛起3：终极之战", "逃离比勒陀利亚", "八佰", "恐龙当家", "地下", "暴君焚城录", "饥饿站台", "超乎想象", "基督圣体", "十二公民", "奇迹的突破", "悲伤逆流成河", "昆虫总动员", "哪吒之魔童降世", "银河补习班", "云端之上", "坚不可摧", "新喜剧之王", "疯狂的外星人", "西蒙妮", "自杀现场直播", "流浪地球", "无名之辈", "寻梦环游记", "女王的旅途", "嗝嗝老师", "影", "黑帮暴徒", "一出好戏", "西虹市首富", "使徒保罗", "摩天营救", "我不是药神", "侏罗纪世界2", "疯狂原始人", "炙热", "奇迹男孩", "中央车站", "芳华", "三块广告牌", "浪潮", "神秘巨星", "无问西东",
    "全球风暴", "羞羞的铁拳", "尊严殖民地", "长城", "圣诞坏公公", "第七封印", "天堂奇迹", "博物馆奇妙夜2", "反贪风暴2", "傲慢与偏见", "博物馆奇妙夜", "宾虚（2016）", "忍者神龟2：破影而出", "独立日2：卷土重来", "我的个神啊", "爱宠大机密", "猎神：冬日之战", "神战：权力之眼", "X战警：天启", "美国队长3", "功夫熊猫3", "聚焦", "小王子", "夏洛特烦恼", "末日崩塌", "左耳", "速度与激情7", "灰姑娘", "七号房的礼物", "超体", "下一站，再爱你", "明日边缘", "归来", "魔戒首部曲：魔戒现身",
    "中国合伙人", "十月围城", "孔子", "一一", "返老还童", "南京！南京！", "海角七号", "梅兰芳", "交响人生", "私人订制", "二弟", "集结号", "黄石的孩子", "暖", "开往春天的地铁", "一年到头", "一个陌生女人的来信", "阿司匹林", "耶稣受难记", "圣诞快乐", "八百壮士", "烈火战车",
]
